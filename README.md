...
1. **Start the Frontend (Vite)**
   From the `appoint` directory:
   ```bash
   npm run dev
   ```

2. **Start the Backend**
   From the `appoint/server` directory:
   ```bash
   node src/index.js
   ```
...
│   ├── src/
│   │   ├── connections/# Database connection logic
...
## 📞 Contact
- **Phone**: +91 9319043772, +91 7451838020
- **Email**: shreekailadevi@gmail.com
- **Instagram**: [@shri_kaila_devi_beauty_parlour](https://www.instagram.com/shri_kaila_devi_beauty_parlour/reels/)
